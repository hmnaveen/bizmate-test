    ...
    <div class="main-content">
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <section>
                    <h3 class="sumb--title m-b-20">Bank Transactions</h3>
                </section>
                        ...
                        <div class="col-xl-7 col-lg-8">
                            <div class="sumb--backAccountsBox sumb--dashstatbox sumb--putShadowbox">
                                ...
                                <div class="bank--cards">
                                     <a href="/add-bank-account"><i class="zmdi zmdi-plus-circle-o"></i></a>
                                </div>
                ...
                @else
                    ...
                    <form action="/bankTransactions"  method="GET" enctype="multipart/form-data" id="transaction_search_form">
                        <div class="selectedBank row m-b-20">
                                    ...
                                    <div class="row" style="height: 100%">
                                        <div class="col-12">
                                            <div class="form-input--wrap">
                                                <select class="form-input--dropdown" name="bankAccount" id="bankAccount">
                                                    @if(count($accounts) > 1)
                                                        @foreach ($accounts as $account)
                                                            <option {{ ( $account['account_id'] == $bankAccount ) ? 'selected' : '' }} value="{{ $account['account_id'] }}">{{ $account['account_name'] }}</option>
                                                        @endforeach
                                                    @else
                                        ...
                                        <div class="col-12">
                                            <div class="transactionBox_wrap">
                                                <div class="transactionBox">
                                                    <div>
                                                        @php
                                                            $currentAccount = $accounts->where('account_id','=', $bankAccount)->first();
                                                        @endphp
                                                        <div class="currentAccount">
                                                            <ul>
                                                                <li>{{ $currentAccount['account_name'] }}</li>
                                                                <li>
                                                                    @if ($currentAccount['class']['type'] == 'credit-card')
                                                                        {{ Str::mask($currentAccount['account_number'], '*', 0, strlen($currentAccount['account_number'])-4 ) }}
                                                                    @else
                                                                        {{ $currentAccount['account_number'] }}
                                                                    @endif
                                                                </li>
                                                                <li>{{ $currentAccount['account_holder'] }}</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-xl-7 col-lg-7">
                                <div class="sumb--backAccountsBox sumb--dashstatbox sumb--putShadowbox">
                                    <div class="bankTransaction--status row" style="height: 100%">

                                        @php

                                            $DebitCount = DB::table('user_bank_transactions')->where('account_id','=',$bankAccount)->where('direction','=','debit')->count();
                                            $CreditCount = DB::table('user_bank_transactions')->where('account_id','=',$bankAccount)->where('direction','=','credit')->count();
                                            $ReconciledCount = DB::table('user_bank_transactions')->where('account_id','=', $bankAccount)->where('is_reconciled','=', 1)->count();
                                            $UnreconciledCount = DB::table('user_bank_transactions')->where('account_id','=', $bankAccount)->where('is_reconciled','=', 0)->count();
                                            
                                        @endphp

                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="status--box_wrap credit">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="status--box_wrap debit">
                                                <div class="status--box">
                                                    <div>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="status--box_wrap recon">
                                                <div class="status--box">
                                                    <div>
                                                        <span>{{ $ReconciledCount }}</span>
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="status--box_wrap unrecon">
                                                <div class="status--box">
                                                    <div>
                            ...
                            <div class="col-xl-3">                                
                                ...
                                <div class="btn-group sumb--dashboardDropdown transaction--filter" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop_type">
                                        ...
                                        <a class="dropdown-item" href="/bankTransactions?bankAccount={{ $bankAccount }}">View All</a>
                                    </div>
                                </div>
                    ...
                    <div class="sumb--recentlogdements sumb--putShadowbox">
                        <div class="table-responsive">
                            <table class="bankTransaction_list">
                                <thead>
                                <tr>
                                ...
                                <tr>
                                    <td style="text-align: center;" colspan="7">No transactions found </td>
                                </tr>
                                @else
                                    @foreach($transactions['data'] as $transaction)
                                    <tr>
                                        <td>
                                            <?php echo substr($transaction['post_date'],0,10); ?>
                                        </td>
                                        <td>
                                            {{ $transaction['class'] }}
                                        </td>
                                        ...
                                        <td class="{{ $transaction['is_reconciled'] ? 'recon'  : 'unrecon' }}" style="text-align: center;">
                                            <span>{{ $transaction['is_reconciled'] ? 'Reconciled'  : 'Unreconciled' }}</span>
                                        </td>
                                    </tr>
                                    @endforeach
                                @endif
...
<script>
        ...
        $("#bankAccount").on("change", function(){
            ...
            if ('URLSearchParams' in window) {
               ...
               // console.log(searchParams.keys())
                 searchParams.set('bankAccount', id);
    ...
    function clearSearchItems(){
        ...
        var url = "{{URL::to('/bankTransactions?bankAccount='.$bankAccount)}}";
        location.href = url;
