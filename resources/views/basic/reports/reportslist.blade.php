                ...
                <section>
                    <div class="row sumb--transactions">
                        <div class="col-xl-12">
                            ...
                            @endif
                            <form action="/basic/reports"  method="GET" enctype="multipart/form-data" id="search_form">
                                <div class="row">
                            ...
                            <form action="/basic/business-activity/export-report"  method="GET" enctype="multipart/form-data" id="" hidden>
                                <div class="col-sm-2">
...
function redirectUrl(transaction_type, id, status){
    ...
    var url = "{{URL::to('/basic/endpoint/{id}/uri_type?from=reports')}}";
