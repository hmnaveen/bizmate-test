                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <form action="/profit-loss"  method="GET" enctype="multipart/form-data" id="search_form">
                                ...
                                <form action="/profit-loss/export-report"  method="GET" enctype="multipart/form-data" id="" hidden>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table @if (Request::get('compare_with_type')) class="withFilter" @endif>
                                            ...
                                            <tbody>
                                                        ...
                                                        @foreach($items as $item)
                                                            ...
                                                            <td>
                                                                @if ($total_particular == 0)
                                                                    -
                                                                @else
                                                                    <a href="/reports?account_id={{$account_id}}&report_start_date={{$start_date}}&report_end_date={{$end_date}}" title="View Transaction">{{number_format($total_particular, 2)}} </a>
                                                                @endif
                                                            </td>
                                                ...
                                                @foreach($items_metadata['receive_money'] as $particular_name)
                                                    <tr>
                                                        <td>
                                                            {{$particular_name}}
                                                        </td>
                                                        ...
                                                        @foreach($items as $item)
                                                            <?php
                                                                $total_particular = 0;$account_id='';$start_date='';$end_date='';
                                                                $transaction_type_index = array_search('receive_money', array_column($item['transactions'], 'transaction_type'));
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($items_metadata['spend_money'] as $particular_name)
                                                    <tr>
                                                        <td>
                                                            {{$particular_name}}
                                                        </td>
                                                        ...
                                                        @foreach($items as $item)
                                                            <?php
                                                                $total_particular = 0;$account_id='';$start_date='';$end_date='';
                                                                $transaction_type_index = array_search('spend_money', array_column($item['transactions'], 'transaction_type'));
                                                ...
                                                @foreach($items_metadata['minor_adjustment'] as $particular_name)
                                                    <tr>
                                                        <td>
                                                            {{$particular_name}}
                                                        </td>
                                                        ...
                                                        @foreach($items as $item)
                                                            <?php
                                                                $total_particular = 0;
                                                                $transaction_type_index = array_search('minor_adjustment', array_column($item['transactions'], 'transaction_type'));
