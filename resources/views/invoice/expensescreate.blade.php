                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-input--wrap">
                                            ...
                                            <div class="date--picker row">
                                                <div class="col-12">
                                                    <input type="text" id="expense_date" name="expense_date" required class="form-control" value="{{ !empty($expense_details['issue_date']) ? $expense_details['issue_date'] :  date('d/m/Y') }}">
                                                    @error('expense_date')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-input--wrap">
                                            ...
                                            <div class="date--picker row">
                                                <div class="col-12">
                                                    <input type="text" id="expense_due_date" name="expense_due_date" required class="form-control" value="{{ !empty($expense_details['due_date']) ? $expense_details['due_date'] : '' }}" autocomplete="off">
                                    ...
                                    <table id="partstable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="width:100px; min-width:100px;">Account</th>
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="float" id="item_unit_price" name="item_unit_price[]" step="any"  required onfocusin="expenseRemoveComma(this)" onfocusout="expenseAddComma(this)">
                                                    </td>
                                                    <td>
                                                        <div class="form-input--wrap">
                                                            <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="float" id="item_unit_price" name="item_unit_price[]" value="{{ !empty($prts['parts_unit_price']) ? number_format($prts['parts_unit_price'], 2) : 0.00 }}" step="any"  required  onfocusin="expenseRemoveComma(this)" onfocusout="expenseAddComma(this)">
                                                </td>
                                                <td>
                                                    <div class="form-input--wrap">
                                                        <div class="row">
                                        ...
                                        @if($type=='edit' && $userinfo[3] != 'user_pro' && ($expense_details['status'] == 'Unpaid' || $expense_details['status'] == 'PartlyPaid'))
   ...
   $(function() {
    ...
    $('#addnewline').on('click', function(){
        ...
        $('#partstable tr.add--new-line').before(
            ...
            '<td><input type=\"float\" step="any" id=\"item_unit_price\" name=\"item_unit_price[]\" required \" onfocusin="expenseRemoveComma(this)" onfocusout="expenseAddComma(this)"></td>\n'+
            '<td>\
        ...
        getExpenseChartAccountsParticularsList(counts);
        getTaxRatesList(counts);
    });
       
    function getExpenseChartAccountsParticularsList(id){
        $.ajaxSetup({
    ...
    function expenseRemoveComma(obj)
    {
