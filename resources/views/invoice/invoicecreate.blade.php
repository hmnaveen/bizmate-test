...
<div class="modal fade modal-reskin modal-invoice--send" id="send_invoice_modal" tabindex="-1" role="dialog" aria-labelledby="send_invoice_modal" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content send-invoice-modal">
            ...
            <form action="/invoice/send-email?invoice_id={{$invoice_id}}"  method="post" enctype="multipart/form-data" id="send_invoice_pop_up">
            {{ method_field('POST') }}
            {{ csrf_field() }}  
                                ...
                                <tbody>
                                    ...
                                    @if (!empty($invoice_details))
                                        ...
                                        <tr id="{{'invoice_parts_row_id_'.$row_index}}" class="invoice_parts_form_cls" >
                                            ...
                                            <td>
                                                <input id="{{'invoice_parts_unit_price_'.$row_index}}" name="{{'invoice_parts_unit_price_'.$row_index}}" type="float" value="{{!empty($parts['parts_unit_price']) ? number_format($parts['parts_unit_price'], 2)  : 0.00}}" onchange="invoicepartsQuantity('{{$row_index}}')" onfocusin='removeComma("invoice_parts_unit_price_{{$row_index}}")' onfocusout='addComma("invoice_parts_unit_price_{{$row_index}}")' step=".01" required>
                                                    ...
                                                    <div class="form-input--wrap">
                                                        <div class="row">
                                                            <div class="col-12 for--tables">
                                                                <select class="form-input--dropdown" id="{{'invoice_parts_tax_rate_'.$row_index}}" name="{{'invoice_parts_tax_rate_'.$row_index}}" onchange="invoicepartsQuantity('{{$row_index}}'); getTaxRates('{{$row_index}}');" value="" required style="display: {{!empty($invoice_details['default_tax']) && $invoice_details['default_tax']=='no_tax' ? 'none' : 'block' }}">
                                                                    <option selected value="0#|#0">Tax Rate Option</option>    
                                                                    @foreach($tax_rates as $tax_rate)
                                        ...
                                        @else
                                            <tr id="invoice_parts_row_id_0" class="invoice_parts_form_cls" >
                                                <td>
                                                    <input placeholder="Search your item list" autocomplete="off" data-toggle="dropdown" id="invoice_parts_name_code_0" name="invoice_parts_name_code_0" type="text" onkeyup="searchInvoiceparts(this, 0)" value="" required>
                                                ...
                                                <td>
                                                    <input id="invoice_parts_quantity_0" name="invoice_parts_quantity_0" type="number" onchange="invoicepartsQuantity(0)" value="" required>
                                                </td>
                                                <td>
                                                    <textarea id="invoice_parts_description_0" name="invoice_parts_description_0" class="autoresizing" value="" required></textarea>
                                                </td>
                                                <td>
                                                    <input id="invoice_parts_unit_price_0" name="invoice_parts_unit_price_0" type="float" value="" onchange="invoicepartsQuantity(0)" onfocusin="removeComma('invoice_parts_unit_price_0')" onfocusout="addComma('invoice_parts_unit_price_0')" >
                                                ...
                                                <td id="invoice_parts_tax_rate_td_0">
                                                    @if(!empty($tax_rates))
                                                        ...
                                                        <div class="form-input--wrap">
                                                            <div class="row">
                                                                <div class="col-12 for--tables">
                                                                    <select class="form-input--dropdown" id="invoice_parts_tax_rate_0" name="invoice_parts_tax_rate_0" onchange="invoicepartsQuantity(0); getTaxRates(0);" required >
                                                                        <option id="0_0" value="0#|#0">Tax Rate Option</option>    
                                                                        @foreach($tax_rates as $tax_rate)
                                        ...
                                        <tr class="add--new-line" style="display: {{ empty($invoice_details['status']) || $invoice_details['status'] === 'Unpaid' ? '' : 'none' }}">
                                            <td colspan="8">
                                                <button class="btn sumb--btn" type="button" id="addnewline" onclick="addInvoiceParts('invoice', 'NULL')" ><i class="fa-solid fa-circle-plus"></i>Add New Line</button> 
                                            </td>
                                        </tr>
                                        ...
                                        @if($type=='edit' && $userinfo[3] != 'user_pro' && ($invoice_details['status'] == 'Unpaid' ||  $invoice_details['status'] == 'Recalled' || $invoice_details['status'] == 'PartlyPaid'))
                        ...
                        <div class="form-navigation">
                            <div class="form-navigation--btns row">
                                ...
                                <div class="col-xl-8 col-lg-10 col-md-9 col-sm-12 col-xs-12 col-12">
                                    ...
                                    <!-- <input type="hidden" name="transaction_type" value="{{!empty($invoice_details && $invoice_details['transaction_type']) ? $invoice_details['transaction_type'] : 'invoice'}}"> -->
                                    ...
                                    <?php if($type == 'edit' && ($invoice_details['status'] == 'Unpaid' || ( $invoice_details['status'] == 'Recalled' && !$invoice_details['invoice_sent']))){?>
                                        <div class="btn-group" id="">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#" id="mark_as_sent">Mark as sent</a>                                                
                                                <a class="dropdown-item" href="#" id="send_invoice" onclick="sendInvoice()">Send Invoice</a>
                                            </div>
                                        </div>
                                    <?php }?>
