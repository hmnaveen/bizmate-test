                ...
                <section>
                    ...
                    @if($first_login == 1)
                        <div class="welcome--message m-b-30">
                            ...
                            Here you can keep track of your expenses, send out client invoices, view profit and loss statements, and ultimately, keep track of your transactions. We’re excited to work with you!
                        </div>
                    @endif
                    ...
                    <form action="/invoice/settings/{{$type}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="invoice_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ">
                                ...
                                <div class="sumb-invoicesettings-upload-container d-flex align-items-center justify-content-center m-b-15">
                                    <div id="sumb-file-upload-container">
                                        
                                        <div class="sumb-invoicesettings-dropzone row">
                                            <div class="col-2">
                                        ...
                                        <input id="logo_file" name="logo_file" type="file" class="form-control-file sumb-expense-dropzone-input" onchange="logoUpload()" value="">
                                        <input type="hidden" name="logo_path" id="logo_path" value="{{!empty($invoice_settings) ? $invoice_settings['business_logo'] : '' }}">

                                    </div>
                                    <div id="sumb-receipt-container"></div>
                                </div>
                            </div>
                        </div>
