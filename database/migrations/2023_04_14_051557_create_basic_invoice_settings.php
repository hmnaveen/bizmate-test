...
class CreateBasicInvoiceSettings extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('basic_invoice_settings', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('basic_invoice_settings');
    }
}
